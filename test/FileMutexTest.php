...
class FileMutexTest extends \PHPUnit_Framework_TestCase
{
    public function test__construct()
    {
        ...
        foreach (['nyan', 'pasu'] as $name1) {
            foreach ([
                         MutexInterface::DOMAIN,
                         MutexInterface::DIRECTORY,
                         MutexInterface::SERVER
                     ] as $type1) {
    ...
    public function testDelete_on_release()
    {
        do {
     ...
     * @backupGlobals
     */
    public function testGetDomainString()
    {
    ...
    public function testGetDirectoryString()
    {
    ...
    public function testRelease_lock()
    {
        do {
    ...
    public function dataCreate_folders_in_path()
    {
        ...
        $data = [
            ...
            [
                $tmp_folder . '/nkt_mutex_test_' . mt_rand(1, 1000000) . '/' . mt_rand(0, 1000000) . '/' .
                mt_rand(0, 1000000),
                null
            ],
        ];
        ...
        $postfix = mt_rand(0, 1000000);
        $data[] = [
            $folder . '/' . mt_rand(0, 1000000) . '/' . mt_rand(0, 1000000) . '/../../' . $postfix,
            $folder . '/' . $postfix
        ];
     ...
     */
    public function testCreate_folders_in_path($string, $real_path = null)
    {
    ...
    public function testCreate_folders_in_path_exception1()
    {
        if (file_exists('/proc')) {
    ...
    public function testCreate_folders_in_path_exception2()
    {
        if (file_exists('/proc')) {
     ...
     */
    public function testGet_last_php_error_as_string()
    {
    ...
    public function dataSanify_path()
    {
        return [
            ['/dev/shm/', '/dev/shm'],
     ...
     */
    public function testSanify_path($input, $expected)
    {
